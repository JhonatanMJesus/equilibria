  ...
  return (
    <>
      ...
      <a
        ...
        className="fixed bottom-4 right-4 md:bottom-6 md:right-6 flex items-center bg-[var(--verde-menta)] hover:bg-[var(--dourado-suave)] text-[var(--azul-profundo)] px-4 py-2 md:px-5 md:py-3 rounded-full shadow-lg transition-all duration-300 group z-50 text-sm md:text-base"
      >
